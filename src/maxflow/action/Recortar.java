...
public class Recortar extends AbstractAction {
	
	
	public static final String NAME_VALUE = "Recortar";
	
	public static final int MNEMONIC_CODE = KeyEvent.VK_CONTROL;

	public static final String LONG_DESCRIPTION_VALUE = "Recortar";

	public final Icon SMALL_ICON_VALUE = 
	new ImageIcon(getClass().getClassLoader().getResource( "gif/cut.gif" ));

	public static final String SHORT_DESCRIPTION_VALUE = "Recortar";
	...
	public Recortar(GpdGraph graph, Action a) {

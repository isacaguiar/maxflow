...
public class Colar extends AbstractAction {
	
	
	public static final String NAME_VALUE = "Colar";
	
	public static final int MNEMONIC_CODE = KeyEvent.VK_CONTROL;

	public static final String LONG_DESCRIPTION_VALUE = "Colar";

	public final Icon SMALL_ICON_VALUE = 
	new ImageIcon(getClass().getClassLoader().getResource( "gif/paste.gif" ));

	public static final String SHORT_DESCRIPTION_VALUE = "Colar";
	...
	public Colar(GpdGraph graph, Action a) {

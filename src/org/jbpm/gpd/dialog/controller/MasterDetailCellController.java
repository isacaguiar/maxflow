...
public class MasterDetailCellController extends AbstractController implements
	...
	public void saveStateDataButton_actionPerformed(ActionEvent e) {
		...
		if (lastSelection.getUserObject() instanceof ActivityStateVO) {
			...
			// só permitir modificar a role se tiver conectado no eflow
	...
	/**
	 * Método que dispara a ação para salvar as propriedades do SubProcesso
	 * @param e
	 */
	...
	/**
	 * Método que dispara a ação para salvar as propriedades do Processo. 
	 * @param e
	 */
	...
	/**
	 * Método que dispara a ação que salva dados dos paineis básicos.
	 * @param e
	 */
	...
	public void descriptionDataButton_actionPerformed(ActionEvent e) {
		...
		// stylepad.open("DESCRIÇÃO");
		RtfEditorFactory.getInstance().createEditor("Definições",
	...
	public void applicationDataButton_actionPerformed(ActionEvent e) {
		...
		// stylepad.open("APLICAÇÃO");
		RtfEditorFactory.getInstance().createEditor("Aplicação",
	...
	public void descriptionSubProcessDataButton_actionPerformed(ActionEvent e) {
		...
		// Stylepad stylepad = new Stylepad(detailPanel.applicationTextField);
		// stylepad.open("APLICAÇÃO");
		RtfEditorFactory.getInstance().createEditor("Descrição",
	...
	public void descriptionStateDataButton_actionPerformed(ActionEvent e) {
		...
		RtfEditorFactory.getInstance().createEditor(
				"Descrição Atividade " + state.getName(),
				detailPanel.descriptionTextField, this);
	}

	/**
	 * método que salva a informação do painel que está ativo no momento
	 * 
	 */
	public void saveCurrent() {
		// exception causada quando o painel é de outro tipo
		try {

...
import org.jbpm.gpd.renderer.PointEdgeHandle;
...
public class GpdMarqueeHandler extends BasicMarqueeHandler {
	...
	protected void paintPort(Graphics g) {
		...
		if (port != null) {
			...
			r.setRect(r.getX() - 3, r.getY() - 3, r.getWidth() + 6, r.getHeight() + 6);
...
//          Control-drag should clone selection
            ...
            TransitionView view = new TransitionView(edge); 
            ...
            graph.getGraphLayoutCache().putMapping(edge, view);           
		}
	}
	...
	public void group(Object[] cells) {
        ...
        cells = graph.getGraphLayoutCache().getCells((CellView[])cells);
	...
	public void insert(Point2D point, DefaultGraphCell vertex) {
		...
		GraphConstants.setBounds(map, new Rectangle((int)point.getX(), (int)point.getY(), (int)size.getWidth(), (int)size.getHeight()));

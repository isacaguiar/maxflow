...
public class PageSetupAction extends AbstractAction
{
    ...
    public static final String NAME_VALUE = "Configurar página ...";
   ...
   /** The long description text of this action */
    ...
    public void actionPerformed( ActionEvent e )
    {
        ...
        if(PrintAction.pageFormat == null) {
        	PrintAction.pageFormat = printJob.defaultPage();
        }
        printJob.pageDialog( PrintAction.pageFormat );
    }
}
